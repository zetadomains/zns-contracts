...
import {IZetaRegistrarController} from "./IZetaRegistrarController.sol"; 
 ...
 */
contract ZetaRegistrarController is 
    Ownable,
    IERC165,
    ERC20Recoverable,
    ReverseClaimer
{
    ...
    bytes32 private constant ZETA_NODE = 0x4c1ec05bdc3ef5e1b7c37e350b926690b2fdaba933c1c608ab5e03737097cd79;
    ...
    function supportsInterface(
        ...
        return
            ...
            interfaceID == type(IZetaRegistrarController).interfaceId;
    }
    ...
    function _setRecords(
        ...
        bytes32 nodehash = keccak256(abi.encodePacked(ZETA_NODE, label));
